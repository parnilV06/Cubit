        ...
        <div className="footer-top-row">
          ...
          <div className="footer-links-grid">
            ...
            <div className="footer-links-col">
              <a href="https://www.linkedin.com/in/parnil-vyawahare" target="_blank" rel="noopener noreferrer" className="footer-social-box" aria-label="LinkedIn">
            ...
            {/* Column 2: GitHub */}
            <div className="footer-links-col">
              <a href="https://github.com/parnilV06" target="_blank" rel="noopener noreferrer" className="footer-social-box" aria-label="GitHub">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <ul className="footer-links-list">
                <li>
                  <a href="https://github.com/parnilV06/Cubit" target="_blank" rel="noopener noreferrer" className="footer-link">
            ...
            {/* Column 3: Discord */}
            <div className="footer-links-col">
              <a href="https://discord.gg/8mt7Ee9zv" target="_blank" rel="noopener noreferrer" className="footer-social-box" aria-label="Discord">
              ...
              <ul className="footer-links-list">
                <li>
                  <a href="https://github.com/sponsors/parnilV06" target="_blank" rel="noopener noreferrer" className="footer-link">Support Us</a>
                </li>
                <li>
                  <a href="https://github.com/parnilV06/Cubit#license" target="_blank" rel="noopener noreferrer" className="footer-link">License</a>
                </li>
              </ul>
            </div>
